...
from header_helpers import navigate_to_header_screen,top_menu_edit,Top_menu_addNewItem
...
class Mobile_Header:
    ...
    def navigate_to_mobile_header_1(self):
            try:

                mobile_head = wait_for_element(self.wait,(By.XPATH, "(//a[normalize-space()='Mobile 1'])[1]"))
...
class TestFathershopTheme:
    ...
    def test_header_functions(self, setup):
        ...
        mobile= Mobile_Header(driver)
        mobile.login()
        mobile.navigate_to_header_screen()
        mobile.navigate_to_mobile_header_1()
        mobile.check_cache_btn()
        mobile.duplicate()
        mobile.filter_search("Cla")
        mobile.create_new_btn()
        #mobile.Topmenu_create( "Top Test")
        #mobile.Top_menu_addNewItem()
        mobile.click_back_btn()
        #mobile.random()
