...
class Breadcrumbs:
    ...
    def navigate_to_breadcrumbs(self):
            try:
                ...
                typo = wait_for_element(self.wait,(By.XPATH, "//a[normalize-space()='Breadcrumbs']"))
...
#———————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
    def test_styles_functions(self, setup):
        ...
        bread = Breadcrumbs(driver)
        bread.login()
        bread.navigate_to_styles_screen()
        bread.navigate_to_breadcrumbs()
        bread.check_cache_btn()
        bread.duplicate()
        bread.delete()
        bread.no_element_dropdown()
        bread.filter_search("Te")
        bread.create_new_btn()
        bread.new_label(" Test")
        bread,open_general()
        bread.color()
